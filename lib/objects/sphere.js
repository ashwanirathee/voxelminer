...
import { gl, shaderVars, scene, camera, renderer } from "../global.js";

const debugkey = "objects_sphere";

debugLog(debugkey, "Loading sphere.js");
...
class Sphere {
  ...
  render() {
    // this is interesting
    if (scene.normalControllerState) this.textureAtlasNum = -3;
    else this.textureAtlasNum = -6;

    gl.uniform1i(shaderVars.attribs.u_whichTexture, this.textureAtlasNum);
