...
export class PhongShader {
  ...
  setProgram() {
    ...
    initTextures(this.gl, [
      { url: "/VoxelMiner/lib/assets/uvCoords.png", unit: 0, sampler: this.shaderVars.uniforms.u_Sampler0 },
      { url: "/VoxelMiner/lib/assets/dice.png", unit: 1, sampler: this.shaderVars.uniforms.u_Sampler1 },
      { url: "/VoxelMiner/lib/assets/texture.png", unit: 2, sampler: this.shaderVars.uniforms.u_Sampler2 },
    ]);
  }
