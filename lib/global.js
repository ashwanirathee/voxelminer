...
export const camera = new Camera([0, 0, 30], [0, 0, -1],  [0, 1, 0], 45.0, canvas.width / canvas.height, 0.001, 100, gl, canvas);
...
function main() {
  ...
  addEventListeners(canvas, gl, camera, u_ViewMatrix, normalControllerState, u_ProjectionMatrix);
