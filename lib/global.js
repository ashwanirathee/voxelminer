...
import { initShaders, createProgram } from "./third-party/cuon-utils.js";
...
// keep the starting eye height and lookat height same, else the camera will go underground
export const camera = new Camera([-14, 1.5, 14], [-0.01, 1.5, -0.01], [0, 1, 0], 60.0, canvas.width / canvas.height, 0.001, 100, gl, canvas);
...
export function main() {
  ...
  // Ensure gl is the WebGL context, and u_Sampler0, u_Sampler1, u_Sampler2 are valid
  initTextures(gl, [
    { url: "./lib/assets/uvCoords.png", unit: 0, sampler: u_Sampler0 },
    { url: "./lib/assets/dice.png", unit: 1, sampler: u_Sampler1 },
    { url: "./lib/assets/texture.png", unit: 2, sampler: u_Sampler2 },
  ]);
