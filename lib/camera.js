...
export class Camera {
   ...
   */
  constructor(speed, alpha, g_eye, g_at, g_up, field_angle, asp_ratio, near_plane, far_plane, gl, canvas) {
   ...
   * @param {number} newAlpha - The new alpha value.
   */
  ...
  /**
   * Moves the camera down by a specified speed.
   * @param {WebGLRenderingContext} gl - The WebGL rendering context.
   * @param {mat4} u_ViewMatrix - The view matrix uniform.
   */
  moveDown(gl, u_ViewMatrix) {
    var f = new Vector3([this.at.elements[0], this.at.elements[1], this.at.elements[2]]);
    f.sub(this.eye);
    f.normalize();
